...
//        fareCalculatorService = new FareCalculatorService(ticketDAO);
    ...
    @Test
    public void calculateFareCarFreeForLessThanThirtyMinutes() {
    	Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  29 * 60 * 1000) );//29 min parking time should give
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
        ticket.setInTime(inTime);
        ticket.setOutTime(outTime);
        ...
        fareCalculatorService.calculateFare(ticket);
        double free = 0.0;
        assertEquals(free, ticket.getPrice());
    }
    
    @Test
    public void calculateFareBikeFreeForLessThanThirtyMinutes() {
    	Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (29 * 60 * 1000) );//29 min parking time should give
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE,false);
    ...
    @Test
    public void calculateFareCarForThirtyMinutesParking() {
    	Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  30 * 60 * 1000) );//30 min parking time should give
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
        ticket.setInTime(inTime);
        ticket.setOutTime(outTime);
